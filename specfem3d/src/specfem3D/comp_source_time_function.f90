...
!=====================================================================
  ...
  ! source-time function used in Zhao et al.,2005 & Po et al.,2010
   a=60.
   b=0.65
   comp_source_time_function = exp(-a*(t-b/2)**2)   
...
!
  ...
  double precision :: hdur_decay,a,b
  ...
  ! a=60.
  ! b=0.65
  ! comp_source_time_function_gauss = exp(-a*(t-b/2)**2)   
